        ...
        <section className=" bg-primary-light">
          <div className="container">
            <div className="content-inner-1 text-center">
              <p className="text">
                For us, that sunset was a poetic gesture signalling the end of
                the relentless wheels of the traditional real-estate engine. We
                bring experiences from the world of economics, real estate, and
                product development to disrupt the status quo and usher in an
                era of empowering YOU! The journey has by no means come to an
                end! Join us on our mission of democratizing real estate.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="row about-bx2 style-1 align-items-center">
              ...
              <div className="col-lg-6 about-content ps-lg-5 m-b30">
                <div className="section-head">
                  <h2 className="title">
                    To make real estate accessible for everyone by using the
                    power of data and technology
                  </h2>
                  <p className="m-0 lh-base">
                    SecondaryDAO was founded with the simple mission of making
                    everyone a part of a fair and inclusive real estate
                    ecosystem
                  </p>
                </div>
                <Link
