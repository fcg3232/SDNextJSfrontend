...
const trustBlog = [
	{ image: wallet, title: 'Fully Transparent', desc: "The projects declare everything openly, be it project costs or legal affairs" },
	{ image: wallet, title: 'Flexible Payments', desc: "Making real estate affordable and inclusive for everyone. Get in and out of your investment, while getting paid rent daily." },
];
		...
		<div>
			...
			<div className="page-content">
					...
					<div className="container">
						<div className="row align-items-center">
							...
							<div className="col-12 text-center">
								<h1 className="" >Fractional and frictionless
									<br />Real Estate investing wisdom from the pros.</h1>
								<p className="text text-primary " >Invest in projects for as little as $50</p>
								...
								<Link to={"/marketplace"} className="btn space-lg btn-gradient btn-shadow btn-primary " >Visit MarketPlace</Link>
							</div>
						</div>
					</div>
					...
					<div className="container">
						<div className="content-inner-1">
							<div className="section-head text-center">
								...
								<p>
									SecondaryDAO leverages the security of Ethereum, and the affordability of layer 2 
									solutions like Arbitrum, to power it's transactions, backed by a team with 
									over 50 years experience.Maybe Investing in any tokenized fractionalized real estate platform, 
									including SecondaryDAO,involves risk, and Investing in any tokenized fractionalized
									real estate platform, including SecondaryDAO it's important to thoroughly research and understand
									the potential risks before investing. However, there are several factors that may contribute to
									building trust in SecondaryDAO and fractionalized tokenized real estate investing:
								</p>
							</div>
							<div className="row">
				...
				<section className="content-inner bg-light icon-section section-wrapper2">
					<div className="container">
						<div className="section-head text-center">
							<h2 className="title">Servicing <span className="text-primary"> Sellers and Property Investors </span>through a digital platform</h2>
						</div>
									...
									<div className="card overflow-hidden ms-4 " key={index}>
										<div className="card-body d-flex align-items-center">
											...
											<div className="coin-img">
												<img loading="lazy" width="42" height="42" src={item.image?.url} className="img-fluid" alt="" />
											</div>
										</div>
									</div>
								))}
						...
						<div className="row">
							<div className="col">
								<div className={layout.sectionImgReverse}>
									<img loading="lazy" src={pic} alt="pic" className="w-[60%] h-[80%] relative z-[5]" />
								</div>
							</div>
							<div className="col">
								<div className={layout.sectionInfo}>
									...
									<p >
										Invest in rental properties without getting locked in (or out).
										Start with just $50 and collect your first rent payment later today
									</p>
								</div>
							</div>
						</div>
					...
					<div className="container">
						<div className="row">
							...
							<div className="col-xl-5 col-lg-12 m-b30 " >
								<div className="dz-card style-2" loading="lazy" style={{ backgroundImage: "url(" + ma3 + ")" }}>
