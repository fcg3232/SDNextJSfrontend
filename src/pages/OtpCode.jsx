                                        ...
                                        <div className="card-body">
                                            ...
                                            >
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="mb-3 mb-md-4">
                                                        <label className="form-label text-primary">Please Enter OTP Here</label>
                                                        <input name="OTP" type="number" className="form-control" placeholder="OTP"
                                                            onChange={(e) => setUser({ ...user, code: e.target.value })} />
                                                    </div>
                                                    <div className=" mb-3 mb-md-4">
                                                        <label className="form-label text-primary">Enter New Password</label>
