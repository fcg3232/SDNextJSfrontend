                ...
                <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100.8px] leading-[75px]">
                  ...
                  {datas.length > 0 ? (
                    <div className="text-primary">
                      Starting at : ${datas.PropertyDetails.TokenPrice}
                    </div>
                  ) : (
                    <></>
                  )}
                    ...
                    <div className="card-body">
                      <div className="buy-coin">
                        <div>
                          ...
                          <h3>
                            {" "}
                            located {product.location} -{product.propaddress}
                          </h3>
                          <h3>{product.desc}</h3>
                          <br />
                          {datas.length > 0 ? (
                          ...
                          {datas.length > 0 ? (
                            <>
                              {datas.PropertyDetails.StartSell == false ? (
                                <h3 className="absolute text-2xl bg-gray-800 ml-8 py-2 px-4 text-green-300 uppercase rounded-xl bottom-5 left-5">
                                  InActive
                                </h3>
                              ) : (
                                <>
                                  <h3 className="absolute ml-8 text-2xl bg-gray-800  py-2 px-4 text-green-300 uppercase rounded-xl bottom-5 left-5">
                                    Active
                                  </h3>
                                </>
                              )}
