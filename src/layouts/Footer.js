        ...
        <>
            <footer className="site-footer style-1" id="footer">
                        ...
                        <div className="row">
                            <div className="col-xl-4 col-lg-12 col-md-12" >
                                <div className="widget widget_about">
                                    ...
                                    <p>For the first time, investors around the globe can buy into the US real estate market
                                        through fully-compliant, fractional, tokenized ownership. Powered by blockchain</p>
                            ...
                            <div className="col-xl-2 col-lg-4 col-md-4 col-sm-6" >
                                <div className="widget widget_services">
                                    ...
                                    <ul>
                                        ...
                                        <li><Link  to={"/blog-list"}>Our Blogs</Link></li>
                            ...
                            <div className="col-xl-3 col-lg-4 col-sm-12" >
                                <div className="widget widget_locations">
                                    ...
                                    <div className="clearfix">
                                        ...
                                        <p>6 State RD Suite 117 Mechanicsburg,
                                            PA 17050-7957 USA</p>
                                        <img src={flags} alt="" />
                                    </div>
                                </div>
                ...
                <div className="footer-bottom text-center">
                    <div className="container">
                        <span className="copyright-text">Copyright © 2023 <a href="https://secondarydao.com/" target="_blank">SecondaryDAO</a>. All rights reserved.</span>
                    </div>
                </div>
            </footer>
        </>
